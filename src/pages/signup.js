...
return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
        <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-8">
            ...
            <img src="/logo.png" alt="" className="w-48 h-48 mr-2" />
        </div>
        <form className="space-y-4">
            <div>
                <label className="text-gray-700 font-medium" htmlFor="name">Name</label>
                <input type="name" id="name" name="name" placeholder="Enter your full name" className="mt-1 block w-full rounded-md border-gray-300 bg-gray-50 shadow-sm focus:border-red-500 focus:ring-red-500 focus:ring-opacity-50" />
            </div>
            <div>
                <label className="text-gray-700 font-medium" htmlFor="email">Username</label>
                <input type="username" id="username" name="username" placeholder="Enter a user name" className="mt-1 block w-full rounded-md border-gray-300 bg-gray-50 shadow-sm focus:border-red-500 focus:ring-red-500 focus:ring-opacity-50" />
            </div>
            <div>
            ...
            <div>
                ...
                <input type="password" id="password" name="password" placeholder="Enter your password again" className="mt-1 block w-full rounded-md border-gray-300 bg-gray-50 shadow-sm focus:border-red-500 focus:ring-red-500 focus:ring-opacity-50" />
            </div>
            <div>
